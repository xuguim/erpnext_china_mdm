...
doctype_list_js = {
	"Sales Order" : "mdm/custom_form_script/sales_order/sales_order_list.js",
}
...
override_doctype_class = {
	...
	'Sales Order': 'erpnext_china_mdm.mdm.custom_form_script.sales_order.sales_order.MdmSalesOrder',
}
override_whitelisted_methods = {
...
scheduler_events = {
	"cron": { 
        ...
        "0 3 * * *": [
            "erpnext_china_mdm.mdm.custom_form_script.wecom.update_employee_department"
        ],
        "0 4 * * *": [
